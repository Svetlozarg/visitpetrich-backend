...
router.get("/all", validateTokenHandler_1.validateToken, place_controller_1.getAllPlaces);
router.get("/:id", validateTokenHandler_1.validateToken, place_controller_1.getPlace);
