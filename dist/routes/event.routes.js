...
router.get("/all", validateTokenHandler_1.validateToken, event_controller_1.getAllEvents);
router.get("/:id", validateTokenHandler_1.validateToken, event_controller_1.getEvent);
